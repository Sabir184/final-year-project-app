...
export async function getAllOfCollection(collection, where) {
  let data = [];
  let querySnapshot;
...
export const saveData = async (collection, doc, jsonObject) => {
  try {
    await db
    .collection(collection)
    .doc(doc)
...
export const getData = async (collection, doc, objectKey) => {
...
export function docIdGenerator(collection) {
